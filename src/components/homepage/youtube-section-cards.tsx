...
import { tw, withBunnyThumbnail } from '@/utils';
    ...
    >
      ...
      >
        <div className="relative -z-10 aspect-[1.91/1] w-full">
          ...
          <div
            className={tw(
              'absolute top-1/2 left-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center gap-2 rounded-full bg-red-600 px-4 py-2 shadow-lg transition ease-in-out',
