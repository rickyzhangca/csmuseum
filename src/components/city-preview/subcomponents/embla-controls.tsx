...
export const EmblaControls = ({ type, hide, onClick }: EmblaControlsProps) => {
  return (
    <button
      ...
      disabled={hide}
      className={tw(
        'absolute top-1/2 z-10 -translate-y-1/2 cursor-pointer rounded-full bg-white p-3 shadow-xl transition hover:scale-105 hover:bg-gray-200 active:scale-100 active:bg-gray-300',
